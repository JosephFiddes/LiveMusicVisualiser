...
function(set_target_properties_plugin target)
  ...
  target_sources(${CMAKE_PROJECT_NAME} PRIVATE "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.rc" "src/audio-wave-source.cpp" "src/audio-wave-source.hpp")
endfunction()
...
function(target_install_resources target)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/data")
    ...
    foreach(data_file IN LISTS data_files)
      ...
      target_sources(${target} PRIVATE "${data_file}" "src/audio-wave-source.cpp" "src/audio-wave-source.hpp")
